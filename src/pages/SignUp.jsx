...
const SignUp = () => {
  ...
  return (
    <section>
      <h1 className='text-3xl mt-3 text-center font-bold'>Sign Up</h1>
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl m-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <input type="text" name="name" value={name} onChange={onChange} placeholder="Full Name" autoComplete='off'
            ...
            <input type={showPassword ? "text" : "password"} name="password" value={password} onChange={onChange} placeholder="Password"
              className='w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out'
            />
            ...
            <button type='submit' className='w-full bg-blue-600 text-white rounded px-7 py-3 text-sm font-medium uppercase shadow hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800'>Sign up</button>
