...
const SignIn = () => {
  ...
  return (
    <section>
      <h1 className='text-3xl mt-3 text-center font-bold'>Sign In</h1>
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl m-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={onSubmit}>
            ...
            <button type='submit' className='w-full bg-blue-600 text-white rounded px-7 py-3 text-sm font-medium uppercase shadow hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800'>Sign in</button>
